    ...
    public class ViewModel
    {
        ...
        public List<ChatListItems> ChatListItems
        {
            ...
            get
            {
                ...
                new ChatListItems() {IsChatSelected=false, ContactName = "Лагин Дмитрий", LastMessageTime = "06:18 am", Availability = "Offline", Message = "Как нибудь увидимся", IsRead = false, ContactProfilePic="/assets/profile1.jpg"},
                new ChatListItems() {IsChatSelected=false, ContactName = "Лагин Дмитрий", LastMessageTime = "06:18 am", Availability = "Offline", Message = "Как нибудь увидимся", IsRead = false, ContactProfilePic="/assets/profile1.jpg"},
                new ChatListItems() {IsChatSelected=false, ContactName = "Лагин Дмитрий", LastMessageTime = "06:18 am", Availability = "Offline", Message = "Как нибудь увидимся", IsRead = false, ContactProfilePic="/assets/profile1.jpg"}
                };
            }
